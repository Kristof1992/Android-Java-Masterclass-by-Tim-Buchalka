...
public class YoutubeActivity extends YouTubeBaseActivity
    ...
    static final String YOUTUBE_VIDEO_ID = "QuoTl1avjrY";
    static final String YOUTUBE_PLAYLIST = "PLXtTjtWmQhg1l7cppRi48ozVu8sMqHkeQ";
...
//        button1.setLayoutParams(new ConstraintLayout.LayoutParams(400, 100));
...
//        layout.addView(button1);
    ...
    public void onInitializationFailure(YouTubePlayer.Provider provider, YouTubeInitializationResult youTubeInitializationResult) {
        ...
        if (youTubeInitializationResult.isUserRecoverableError()){
            ...
            String errorMessage = String.format("There was an error initializing the YotubePlayer (%1$s)", youTubeInitializationResult.toString());
